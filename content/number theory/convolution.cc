...
/* Returns the convolution of the two given vectors in time proportional to
 * n*log(n). The number of roots of unity to use nroots_unity must be set so
 * that the product of the first nroots_unity primes of the vector
 * nth_roots_unity is greater than the maximum value of the convolution. Never
 * use sizes of vectors bigger than 2^24, if you need to change the values of
